...
class AdimninProgressScreen extends StatefulWidget {
  const AdimninProgressScreen({Key? key}) : super(key: key);

  @override
  State<AdimninProgressScreen> createState() => _AdimninProgressScreen();
}

class _AdimninProgressScreen extends State<AdimninProgressScreen> {
  @override
  final Store =
      FirebaseFirestore.instance.collection('inprogress_admin').snapshots();
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        title: Text(
                            snapshot.data!.docs[index]['fullName'].toString()),
                        // subtitle: Text(Utility.getHumanReadableDate( dt as int)),
                                                          ...
                                                          actions: [
                                                            ...
                                                            TextButton(
                                                                onPressed: () async {
                                                                  Navigator.of(context).pop();
                                                                  if(Store != null){
                                                                    await FirebaseFirestore.instance.collection('inprogress_admin')
