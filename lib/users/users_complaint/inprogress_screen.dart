...
class inProgressScreen extends StatefulWidget {
  ...
  @override
  State<inProgressScreen> createState() => _inProgressScreen();
}

class _inProgressScreen extends State<inProgressScreen> {
  String uid = FirebaseAuth.instance.currentUser!.uid;
  final userStore = FirebaseFirestore.instance.collection('inprogress_users')
                                                        ...
                                                        actions: [
                                                          ...
                                                          TextButton(
                                                              onPressed: () async {
                                                                Navigator.of(context).pop();
                                                                if (userStore != null) {
                                                                  await FirebaseFirestore.instance.collection('inprogress_users')
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Text(
                                                                snapshot.data!.docs[index]['adminReply'].toString(),style: TextStyle(
                                                              fontSize: 18,
                                                            ),),
                                                          ),
